...
<body style="background-color: rgb(213, 108, 116); opacity: .9; ">
    <div class="header bg-main" style="background-color: black; opacity: .8">
        <div class="logo margin-big-left fadein-top">
            <h1>管理员后台</h1>
        </div>
        <div class="head-l">
            <a class="button button-little bg-green" style="background-color: darkred;" href="${ctx}/login/uIndex" target="_blank">
    ...
    <div class="leftnav" style="background-color: black; opacity: .8">
