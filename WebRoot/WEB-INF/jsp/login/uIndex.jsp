...
<!--导航条-->
<div class="width100" style="height: 45px;background: lightgrey;position: relative;z-index: 100;">
    <!--中间的部分-->
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        ...
        <div class="left_yh Selected" style="width: 230px;height: 45px;" id="hiddenShow">
            ...
            <!--导航展开部分-->
            <div class="downSlide" style="background-color: pink">
                <c:forEach items="${lbs}" var="data" varStatus="l">
                    <div class="n1Nav">
                        <font>${data.father.name}</font>
                        <img src="${ctx}/resource/user/images/jt.png" alt="">
                        <div class="n2Nav" style="width:200px;">
                            <div class="n3Nav" style="width:200px;">
        ...
        <div class="right_yh" style="height:28px;width:316px;border:2px solid darkred;margin-top: 5px;">
            <form action="${pageContext.request.contextPath}/item/shoplist" method="post">
                <input type="text" placeholder="关键词查询" class="search" name="condition" value="">
...
<%--   luara插件     --%>
        $(function () {
            $(".example2").luara({width:"966",height:"490",interval:2000,selected:"seleted",deriction:"left"});
        });
    </script>
</div>
<!--折扣商品-->
