...
<!--导航条-->
<div class="width100" style="height: 45px;background: black;margin-top: 40px;position: relative;z-index: 100;">
    <!--中间的部分-->
        ...
        <div id="vipRight">
            <form action="${ctx}/user/exUpdate" method="post" id="myf">
                <div class="hidden_yh bj_fff" style="width: 938px;border: 1px solid #ddd;">
                    ...
                    <div class="width100" style="height: 32px;line-height: 32px;margin-top: 30px; margin-bottom: 60px;">
